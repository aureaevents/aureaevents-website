...
const services = [
  ...
  },
  {
    ...
    description:
      "From intimate picnics and elegant brunches to proposals, bridal & baby showers, naming ceremonies, and milestone celebrations; we create beautifully curated social events that bring people together in style. Every gathering is thoughtfully planned to become a cherished and memorable experience.",
    features: [
      "Cocktail parties",
      "Picnics & brunches",
