    ...
    <footer className="bg-cobalt-900 text-white" role="contentinfo">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="inline-block mb-5">
              <img
                ...
                className="h-12 w-auto object-contain rounded brightness-110"
                width={48}
                height={48}
                loading="lazy"
              />
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-heading text-base text-white mb-5">Quick Links</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="font-heading text-base text-white mb-5">Our Services</h3>
            <span className="gold-line mb-4" />
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h3 className="font-heading text-base text-white mb-5">Get in Touch</h3>
            <span className="gold-line mb-4" />
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-gold-500 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4">
            <a href="#" className="font-body text-xs text-white/40 hover:text-gold-500 btn-transition">
              Privacy Policy
            </a>
            <a href="#" className="font-body text-xs text-white/40 hover:text-gold-500 btn-transition">
              Terms of Service
